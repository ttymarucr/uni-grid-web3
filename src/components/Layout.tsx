        ...
        <div className="flex md:float-right text-lg">
          {isConnected ? (
            <div className="flex items-center justify-between w-full">
              ...
              <button
                onClick={() => disconnect()}
                className="bg-gray-900 hover:bg-gray-800 text-white text-sm md:text-base px-4 py-2 rounded-r h-8 md:h-10 hover:cursor-pointer"
              >
                Disconnect
              </button>
            </div>
